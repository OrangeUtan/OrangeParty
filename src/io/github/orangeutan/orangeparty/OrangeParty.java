...
public class OrangeParty extends JavaPlugin {
    ...
    public static final String CFG_AUTOJOIN_MA_CANCEL_OWNER_JOIN_WHEN_MEMBERS_CANT_JOIN = "autojoin-minigame.mobarena.cancel-owner-join-when-members-cant-join";
